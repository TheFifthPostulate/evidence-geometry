...
<div style="text-align: center;">
  <img src="v2/images/heartdisease_1.png" width="750">
  <p><em>Validation-set risk map.</em></p>
</div>

<div style="text-align: center;">
  <img src="v2/images/heartdisease_2.png" width="750">
...
ggplot(scores_val) +
  geom_point(aes(x=l, y=p, color=num), alpha=0.7) +
  stat_smooth(aes(x=l, y=as.numeric(num)-1), method = "glm",
              method.args = list(family = "binomial"),
              se = TRUE) +
  ylab("Random forest heart disease probability (p)") +
  theme_minimal()
...
ggplot(scores_val) +
  geom_point(aes(x=d_dist, y=p, color=num), alpha=0.7) +
  stat_smooth(aes(x=d_dist, y=as.numeric(num)-1), method = "glm",
              method.args = list(family = "binomial"),
              se = TRUE) +
  ylab("Random forest heart disease probability (p)") +
  theme_minimal()
...
**Else**  
&emsp;**If** $proj > 0$ $\rightarrow$ **Review**  
&emsp;**Else If** $d\_dist \geq 0$ $\rightarrow$ **Review**  
&emsp;**Else** $\rightarrow$ **Healthy**  
