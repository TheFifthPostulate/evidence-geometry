...
Instead of relying only on classifier probability, the framework analyzes each case using two geometric risk signals:
...
- **98%** false negative capture rate through abstention
- Maintain good automated classification rate at **38%**
...
**If** $p > 0.65$ $\rightarrow$ **Heart Disease**  
**Else If** $p > 0.45$ $\rightarrow$ **Review**  
**Else**  
&emsp;**If** $d\_dist > -1$ & $proj > 0$ $\rightarrow$ **Review**  
